...
describe("pos:row()", function ()
	it("returns the row", function ()
		assert.are.equal(0, Pos.new(0, 1):row())
	end)
end)

describe("pos:col()", function ()
	it("returns the col", function ()
		assert.are.equal(1, Pos.new(0, 1):col())
	end)
end)
